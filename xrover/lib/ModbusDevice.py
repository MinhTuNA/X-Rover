...
class Driver(ModbusDevice):
    ...
    def set_motor(self, left_rpm=0, right_rpm=0, left_torque=100, right_torque=100, left_mode=0x41, right_mode=0x41):
        ...
        right_torque_high, right_torque_low = self.split_into_bytes(
            right_torque)
        ...
        header = [self.driver_address, self.write_mode, start_address_high, start_address_low,
                  num_byte_high, num_byte_low, total_byte, left_mode, right_mode]
        payload = [
