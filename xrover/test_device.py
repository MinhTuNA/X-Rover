...
class DevicePortScanner(QObject):
    ...
    def __init__(self):
        ...
        self.rf_module_serial_number = RF_MODULE.serial_number
    ...
    def find_rf_module_port(self,ports):
        if len(ports) == 0:
            return None
        for port in ports:
            if port.serial_number == self.rf_module_serial_number:
                return port.device
        return None
